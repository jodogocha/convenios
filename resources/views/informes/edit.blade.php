{{-- resources/views/informes/edit.blade.php --}}
@extends('layouts.app')

@section('title', 'Editar Informe')
@section('page-title', 'Editar Informe #' . $informe->id)
...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        <div class="alert alert-warning">
            <h6><i class="fas fa-edit mr-2"></i>Editando Informe</h6>
            <div class="row">
                <div class="col-md-3">
                    <strong>Estado actual:</strong> 
                    <span class="badge badge-{{ $informe->estado_badge }}">{{ $informe->estado_texto }}</span>
                </div>
                <div class="col-md-3">
                    <strong>Creado:</strong> {{ $informe->created_at->format('d/m/Y H:i') }}
                </div>
                <div class="col-md-3">
                    <strong>Última modificación:</strong> {{ $informe->updated_at->format('d/m/Y H:i') }}
                </div>
                <div class="col-md-3">
                    <strong>Creado por:</strong> {{ $informe->usuarioCreador->nombre_completo }}
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('informes.update', $informe) }}" id="informeForm">
            @csrf
            @method('PUT')
                                ...
                                <select class="form-control @error('convenio_id') is-invalid @enderror" 
                                    ...
                                    @foreach($convenios as $convenio)
                                        <option value="{{ $convenio->id }}" 
                                                {{ old('convenio_id', $informe->convenio_id) == $convenio->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('institucion_co_celebrante', $informe->institucion_co_celebrante) }}" 
                                       required
                                       maxlength="255">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('unidad_academica') is-invalid @enderror" 
                                    ...
                                    @foreach($unidadesAcademicas as $valor => $nombre)
                                        <option value="{{ $valor }}" {{ old('unidad_academica', $informe->unidad_academica) == $valor ? 'selected' : '' }}>
                                            {{ $nombre }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="carrera" 
                                       name="carrera" 
                                       value="{{ old('carrera', $informe->carrera) }}" 
                                       required
                                       maxlength="255"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_celebracion', $informe->fecha_celebracion?->format('Y-m-d')) }}" 
                                       required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="vigencia" 
                                       name="vigencia" 
                                       value="{{ old('vigencia', $informe->vigencia) }}" 
                                       maxlength="100"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('periodo_evaluado') is-invalid @enderror" 
                                          ...
                                          required
                                          maxlength="500"
                                          placeholder="Describe el periodo específico que se está evaluando...">{{ old('periodo_evaluado', $informe->periodo_evaluado) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" 
                                       ...
                                       id="periodo_desde" 
                                       name="periodo_desde" 
                                       value="{{ old('periodo_desde', $informe->periodo_desde?->format('Y-m-d')) }}">
                                @error('periodo_desde')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" 
                                       ...
                                       id="periodo_hasta" 
                                       name="periodo_hasta" 
                                       value="{{ old('periodo_hasta', $informe->periodo_hasta?->format('Y-m-d')) }}">
                                @error('periodo_hasta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('dependencia_responsable', $informe->dependencia_responsable) }}" 
                                       required
                                       maxlength="255"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('convenio_celebrado_propuesta', $informe->convenio_celebrado_propuesta) }}" 
                                       required
                                       maxlength="500"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div id="coordinadores-container">
                                    @php
                                        $coordinadores = old('coordinadores_designados', $informe->coordinadores_designados ?? []);
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tipo_convenio') is-invalid @enderror" 
                                    ...
                                    @foreach($tiposConvenio as $valor => $nombre)
                                        <option value="{{ $valor }}" {{ old('tipo_convenio', $informe->tipo_convenio) == $valor ? 'selected' : '' }}>
                                            {{ $nombre }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" 
                                           ...
                                           value="1"
                                           {{ old('convenio_ejecutado', $informe->convenio_ejecutado) ? 'checked' : '' }}>
                    ...
                    <div id="seccion-ejecutado" style="{{ old('convenio_ejecutado', $informe->convenio_ejecutado) ? '' : 'display: none;' }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('numero_actividades_realizadas', $informe->numero_actividades_realizadas) }}" 
                                           min="0"
                                           step="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('logros_obtenidos') is-invalid @enderror" 
                                              ...
                                              rows="4"
                                              placeholder="Describa los principales logros obtenidos...">{{ old('logros_obtenidos', $informe->logros_obtenidos) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('beneficios_alcanzados') is-invalid @enderror" 
                                              ...
                                              rows="4"
                                              placeholder="Describa los beneficios alcanzados...">{{ old('beneficios_alcanzados', $informe->beneficios_alcanzados) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Describa las dificultades encontradas...">{{ old('dificultades_incidentes', $informe->dificultades_incidentes) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Describa el uso de instalaciones...">{{ old('responsabilidad_instalaciones', $informe->responsabilidad_instalaciones) }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Sugerencias para mejorar...">{{ old('sugerencias_mejoras', $informe->sugerencias_mejoras) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Información adicional...">{{ old('informacion_complementaria', $informe->informacion_complementaria) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="seccion-no-ejecutado" style="{{ old('convenio_ejecutado', $informe->convenio_ejecutado) ? 'display: none;' : '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('motivos_no_ejecucion') is-invalid @enderror" 
                                              ...
                                              rows="5"
                                              placeholder="Explique detalladamente los motivos...">{{ old('motivos_no_ejecucion', $informe->motivos_no_ejecucion) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Propuestas para futura ejecución...">{{ old('propuestas_mejoras', $informe->propuestas_mejoras) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="4"
                                              placeholder="Información adicional...">{{ old('informacion_complementaria_no_ejecutado', $informe->informacion_complementaria_no_ejecutado) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('enlace_google_drive', $informe->enlace_google_drive) }}" 
                                       required
                                ...
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle mr-1"></i>
                                    Pegue aquí el enlace de la carpeta de Google Drive que contiene todas las evidencias
                                </small>
                                @if($informe->enlace_google_drive)
                                <div class="mt-2">
                                    <a href="{{ $informe->enlace_google_drive }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                        <i class="fab fa-google-drive mr-1"></i>
                                        Ver Evidencias Actuales
                                    </a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div id="firmas-container">
                                    @php
                                        $firmas = old('firmas', $informe->firmas ?? []);
                                        if (empty($firmas)) {
                                            $firmas = [''];
                                        }
                                    @endphp
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_presentacion', $informe->fecha_presentacion?->format('Y-m-d')) }}" 
                                       required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="observaciones" 
                                          rows="3"
                                          placeholder="Observaciones adicionales sobre el informe...">{{ old('observaciones', $informe->observaciones) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
